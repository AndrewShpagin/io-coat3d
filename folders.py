...
def InitFolders():
    ...
    if(not os.path.isfile(exchangeFile)):
        ...
        if len(savedExchangePath) > 0 : coat3D.exchangeFolder = savedExchangePath
...
def loadExchangeFolder():
    ...
    if(platform == 'win32' or platform == 'darwin'):
        DC2Folder = os.path.expanduser("~") + os.sep + 'Documents' + os.sep + '3DC2Blender'
        basePath = os.path.expanduser("~") + os.sep + 'Documents' + os.sep
    else:
        DC2Folder = os.path.expanduser("~") + os.sep + '3DC2Blender'
        basePath = os.path.expanduser("~") + os.sep
    ...
    if len(coat3D.exchangeFolder) == 0:
        coat3D.exchangeFolder = basePath + 'AppLinks' + os.sep + '3D-Coat' + os.sep + 'Exchange'
